...
// // application/views/admin/product-add.php
      ...
      <div class="dashboard-wrapper">
        <div class="dashboard-ecommerce">
          <div class="container-fluid dashboard-content ">
            ...
            <form  action="<?php echo (htmlspecialchars(base_url() . "index.php/admin/addProduct")) ?>" method="POST" enctype="multipart/form-data" >
              <div class="row">
